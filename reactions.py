...
PROB = {
    "moai": 0.25,          # 🗿
    "laugh": 0.18,         # 😂🤣😆
    "names": 0.30,         # اسم سازنده / استدیو
    "bye": 0.35,           # خداحافظی
    "hello": 0.28,         # سلام
    "ajab": 0.40,          # عجب → رجب
    "aa": 0.35,            # عا / بع / باع
    "swear_joke": 0.22,    # کس/کص/کث/نچ/نوچ/کونی (شوخی)
    "chetori": 0.30,       # چطوری
    "reply_to_bot": 0.45,  # ریپلای روی پیام ربات
    "bot_call": 0.70,      # بات / ربات — کمی بالاتر چون صدا زدنه
    "random_chat": 0.02,   # پیام تصادفی بدون تریگر
}

# کول‌داون کلی واکنش در هر گروه (ثانیه)
GROUP_REACTION_COOLDOWN = 25

# کول‌داون پیام تصادفی در هر گروه (ثانیه)
RANDOM_CHAT_COOLDOWN = 25 * 60

# کول‌داون per-user برای جلوگیری از اسپم یک نفر
USER_REACTION_COOLDOWN = 18
...
RESPONSES = {
    ...
    "random_chat": [
        ...
        "بشهههه منهههههه گبونش بشم منهههههه💆‍♀️",
        "حاجی حوصلمون پکید یه هایده بذارید تو گپ.."
    ],
}
