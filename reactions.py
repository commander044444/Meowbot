...
PROB = {
    "moai": 0.20,          # 🗿
    "laugh": 0.15,         # 😂🤣😆
    "names": 0.40,         # اسم سازنده / استدیو
    "bye": 0.30,           # خداحافظی
    "hello": 0.25,         # سلام
    "ajab": 0.35,          # عجب → رجب
    "aa": 0.45,            # عا / بع / باع
    "swear_joke": 0.20,    # کس/کص/کث (شوخی)
    "chetori": 0.30,       # چطوری
    "reply_to_bot": 0.55,  # ریپلای روی پیام ربات
    "random_chat": 0.03,   # پیام تصادفی بدون تریگر
}
...
RESPONSES = {
    ...
    "reply_to_bot": [
        ...
        "من اینجوری‌ام دیگه 🫠",
        "آره منم 🗿",
        "همینم که هستی می‌بینی 😂",
        "ریپلای کردی روش؟ جرأت داری 🗿",
        "من اینورم دیگه 🥹🗿",
        "چیشد 🗿",
    ],
    "random_chat": [
